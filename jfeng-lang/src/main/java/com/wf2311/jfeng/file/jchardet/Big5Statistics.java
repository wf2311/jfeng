...
package com.wf2311.jfeng.file.jchardet;

public class Big5Statistics extends NsEUCStatistics {

    private static float[] mFirstByteFreq;
    private static float mFirstByteStdDev;
    private static float mFirstByteMean;
    private static float mFirstByteWeight;
    private static float[] mSecondByteFreq;
    private static float mSecondByteStdDev;
