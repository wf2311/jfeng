...
public class TimeConsts {
    ...
    static {
        ...
        map.put(FormatterStyle.CN_YYYY_MM, "2017年04月");
        map.put(FormatterStyle.CN_YYYY_MM_DD, "2017年04月21日");
        map.put(FormatterStyle.CN2_YYYY_MM_DD, "2017年04月21号");
        map.put(FormatterStyle.CN_YYYY_MM_DD_HH, "2017年04月21日 13点");
        map.put(FormatterStyle.CN_2_YYYY_MM_DD_HH, "2017年04月21日 13时");
        map.put(FormatterStyle.CN2_YYYY_MM_DD_HH, "2017年04月21号 13点");
        map.put(FormatterStyle.CN2_2_YYYY_MM_DD_HH, "2017年04月21号 13时");
        map.put(FormatterStyle.CN_YYYY_MM_DD_HH_MM, "2017年04月21日 13:27");
        map.put(FormatterStyle.CN_2_YYYY_MM_DD_HH_MM, "2017年04月21日 13点27分");
        map.put(FormatterStyle.CN_3_YYYY_MM_DD_HH_MM, "2017年04月21日 13时27分");
        map.put(FormatterStyle.CN2_YYYY_MM_DD_HH_MM, "2017年04月21号 13:27");
        map.put(FormatterStyle.CN2_2_YYYY_MM_DD_HH_MM, "2017年04月21号 13点27分");
        map.put(FormatterStyle.CN2_3_YYYY_MM_DD_HH_MM, "2017年04月21号 13时27分");
        map.put(FormatterStyle.CN_YYYY_MM_DD_HH_MM_SS, "2017年04月21日 13:27:59");
        map.put(FormatterStyle.CN_2_YYYY_MM_DD_HH_MM_SS, "2017年04月21日 13点27分59秒");
        map.put(FormatterStyle.CN_3_YYYY_MM_DD_HH_MM_SS, "2017年04月21日 13时27分59秒");
        map.put(FormatterStyle.CN2_YYYY_MM_DD_HH_MM_SS, "2017年04月21号 13:27:59");
        map.put(FormatterStyle.CN2_2_YYYY_MM_DD_HH_MM_SS, "2017年04月21号 13点27分59秒");
        map.put(FormatterStyle.CN2_3_YYYY_MM_DD_HH_MM_SS, "2017年04月21号 13时27分59秒");
